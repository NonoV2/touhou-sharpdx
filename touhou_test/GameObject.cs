...
namespace touhou_test
{
    class GameObject
    {
        ...
        //public float ratioX = 1.0f; // ratio = texture size / window size
        //public float ratioY = 1.0f;
        //public float baseRatioX = 1.0f; // baseRatio = 1 / window size
        //public float baseRatioY = 1.0f; //
        ...
        public GameObject(SharpDX.Direct3D11.ShaderResourceView resourceView, GameLogic gl)
        {
            ...
            using (var resource = resourceView.Resource)
            {
        ...
        public virtual void Draw()
        {
            ...
            gl.ghSharpDX.batch.Batch.Draw(
                ...
                SharpDX.Color.White, // tint color, use white for normal color
        ...
        */
        ...
        public bool collideWith(GameObject go) {
            ...
            if (finalOriginX + finalCoordX * hitboxFactor <= go.finalOriginX + go.finalCoordX * go.hitboxFactor &&
                finalOriginX + finalCoordX * hitboxFactor >= go.finalOriginX - go.finalCoordX * go.hitboxFactor &&
                finalOriginY + finalCoordY * hitboxFactor <= go.finalOriginY + go.finalCoordY * go.hitboxFactor &&
                finalOriginY + finalCoordY * hitboxFactor >= go.finalOriginY - go.finalCoordY * go.hitboxFactor) return true;
